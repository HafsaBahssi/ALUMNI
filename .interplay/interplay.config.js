...
module.exports = () => {
  return {
    ...
    //designTokens: [
    //    {
    //      path: "./relative/path/to/tokens.json",         // Design tokens JSON file
    ...
    //packages: [
    //   {
    //     packagePath: "./relative/path/to/package.json",      //Path to package.json for package to import
    //     build: "./relative/path/to/index.js",                //Entry file for component bundling

    //     src: "./relative/path/to/index.js",                  //Entry file for component parsing
