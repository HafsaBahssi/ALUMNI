...
export namespace InterplayCLI {
    ...
    type Package = {
        ...
        /** Relative path to component index to use for build, from base of repo */
        build?: string;

        /** Relative path to single-file UMD bundle of your component index (use instead of build), from base of repo */
        bundle?: string;
